...
| 5    | ViewHolder模式的概念和用法                                   |          |          |            |
| 6    | Fragment生命周期                                             |          |          |            |
| 7    | ClassLoader的原理                                            |          |          |            |
| 8    | Fragment与Fragment之间如何通信                               |          |          |            |
| 9    | Activity生命周期                                             |          |          |            |
| 10   | Activity之间如何通信                                         |          |          |            |
| 11   | Fragment和Activity之间的关系                                 |          |          |            |
| 12   | 为什么只能用默认的Fragment方法来创建Fragment对象             |          |          |            |
| 13   | Bundle被Android组件之间用来传递数据，Bundler内部也是一个Map，为什么传数据不直接用HashMap？ |          |          |            |
| 14   | 谈谈Serializable 和 Parcelable 接口的区别                    |          |          |            |
| 15   | 解释一下Android的隐式Intent和显式Intent                      |          |          |            |
| 16   | Android广播和EventBus的区别                                  |          |          |            |
| 17   | 什么是 supportLibrary ？为什么要引入supportLibrary？         |          |          |            |
| 18   | ANR的出现原因以及处理方式                                    |          |          |            |
| 19   | Bitmap如何优化，三级缓存的思想和逻辑                         |          |          |            |
| 20   | Dalvik 和 Art的区别                                          |          |          |            |
| 21   | 内存溢出是如何发生的                                         |          |          |            |
| 22   | 如何理解上下文Context                                        |          |          |            |
| 23   | onTrimMemory（）方法是什么                                   |          |          |            |
...
| 17   | [手把手讲解 ViewPager翻页特效](手把手讲解 ViewPager翻页特效) |
